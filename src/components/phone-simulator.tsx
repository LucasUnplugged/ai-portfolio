...
export function PhoneSimulator({ children }: PhoneSimulatorProps) {
  return (
    <>
      ...
      <div className="md:hidden h-[calc(100vh-3.5rem)] w-full overflow-y-auto">
        {children}
      </div>

      {/* Desktop: phone frame */}
      <div className="hidden md:flex min-h-[calc(100vh-3.5rem)] items-center justify-center p-8">
